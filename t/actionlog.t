...
test_log { message_id => 'CHECKLIST_CREATE', parameters => '{"member_id":1234}', created_at => "mogefuga" }
        => { message => "1234 さんが '' を追加しました", type => "チェックの追加", created_at => "mogefuga" };

test_log { message_id => 'CHECKLIST_CREATE', parameters => '{"member_id":1234,"circle_name":5678}', created_at => "piyopiyo" }
        => { message => "1234 さんが '5678' を追加しました", type => "チェックの追加", created_at => "piyopiyo" };
