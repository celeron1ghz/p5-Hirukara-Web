...
subtest "both member_id and name updated" => sub {
    output_ok {
     ...
     ,qr/\[INFO\] ASSIGNLIST_NAME_UPDATE: assign_id=1, member_id=mogemoge, before_name=mogefuga 割り当てリスト, after_name=assign name1/;
    ...
    actionlog_ok $m
        , { type => '割り当て名の変更',   message => 'mogemoge さんが割り当てID 1 の名前を変更しました。(変更前=mogefuga 割り当てリスト,変更後=assign name1)' }
